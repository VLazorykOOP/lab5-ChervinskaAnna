...
using namespace std;
	...
	class Car {
		public:
			...
			Car(string marka, int cylinder, int power) {
				this->Marka = marka;
	...
	public:
		...
		Lorry(string marka, int cylinder, int power, int vantajy):Car(marka, cylinder, power) {
			this->Vantajy = vantajy;
		}

		void setVantajy(int a) {
			this->Vantajy = a;
		}
	...
	void Task1() {
		...
		obj.setPower(4);
		obj.printInfo();
		Lorry obj1 = Lorry("RENAULT", 5, 9, 2);
		obj1.printInfo();
		obj1.setVantajy(7);
		obj1.setMarka("TESLA");
		obj1.printInfo();
	...
	public:
		...
		void printInfo() {
			cout << "X =" << X << " ";
			cout << "Y=" << Y << " ";
			cout << "ButtonSize=" <<button1.getSize()<< " ";
			cout << endl;
		}
	};
	...
	public:
		...
		WindowWithMenu(int x, int y, int size, int row):Window (x, y, size) {
			this->Row = row;
		}
		...
		void printInfo() {
			cout << "X=" << X << " " << "Y=" << Y << " " << "ButtonSize=" << button1.getSize() << " " << "Row=" << Row << " ";
			cout << endl;
		}
	...
	void Task2() {
		Button obj = Button(4);
		obj.printInfo();
		Window obj1 = Window(3, 4, 6);
		obj1.printInfo();
		WindowWithMenu obj2 = WindowWithMenu(4, 2, 5, 1);
		obj2.printInfo();
	}
